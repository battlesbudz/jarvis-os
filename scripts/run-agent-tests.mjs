...
const tests = [
  ...
  { file: "scripts/__tests__/eyevueIntegration.assert.mjs" },
  ...
  { file: "server/liveActions/__tests__/agentJobProjection.test.ts" },
  { file: "server/liveActions/__tests__/migration.assert.ts" },
  { file: "server/liveActions/__tests__/routes.test.ts" },
  { file: "server/liveActions/__tests__/retryLineage.test.ts" },
  { file: "server/liveActions/__tests__/repository.test.ts", requiresDatabase: true },
