...
const tests = [
  ...
  { file: "server/agent/__tests__/cloudBackgroundEscalation.assert.ts" },
  ...
  { file: "server/agent/__tests__/androidDaemonToolHelpers.assert.ts" },
  ...
  { file: "server/agent/__tests__/providerRuntimeAdapters.assert.ts" },
  ...
  { file: "server/core/runtime/__tests__/runtimeApprovalGateBridge.test.ts" },
  { file: "server/core/runtime/__tests__/runtimeApprovalWorkflow.test.ts" },
  { file: "server/core/runtime/__tests__/runtimeAuditEvent.test.ts" },
  { file: "server/core/runtime/__tests__/runtimeAuditTraceLink.test.ts" },
  { file: "server/core/runtime/__tests__/runtimeApprovalPreview.test.ts" },
  { file: "server/core/runtime/__tests__/runtimeApprovalRequestBridge.test.ts" },
  ...
  { file: "server/core/runtime/__tests__/runtimeE2EAutomation.test.ts" },
  ...
  { file: "server/core/runtime/__tests__/runtimeOwnedGoldenWorkflow.test.ts" },
  { file: "server/core/runtime/__tests__/runtimePersistenceRecord.test.ts" },
  ...
  { file: "server/agent/__tests__/voiceRuntimeResourceScheduler.assert.ts" },
  ...
  { file: "server/brain/__tests__/benchmarks.test.ts" },
