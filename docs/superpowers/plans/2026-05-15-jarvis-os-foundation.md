...
- [x] Add an end-to-end app-chat test that fakes DB/job dependencies and proves `/api/coach/chat` routes a research request into a background job.
- [x] Add production observability for autonomy decisions: mode, agent type, job ID, readiness status, and approval boundary.
