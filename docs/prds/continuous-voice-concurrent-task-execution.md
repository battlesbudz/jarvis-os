...
17. A linked operation fails after an earlier forward step produced an effect; Jarvis fences all remaining unstarted forward work but preserves applicable predeclared compensation, keeps the task nonterminal through the bounded compensation phase, and reports terminal failure only after compensation settles.
