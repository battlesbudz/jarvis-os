...
const TOOL_AWARE_RULES: ToolAwareRule[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /\b(?:latest|current|recent)\s+(?:[$\w.\/&-]+\s+){0,6}(?:news|events?|updates?|sources?|articles?|headlines?|videos?|uploads?|posts?|information|info|data|prices?|scores?|results?|versions?|releases?|rates?|values?|rankings?|standings?|polls?|odds?|availability|status|population|counts?|totals?)\b/i,
      ...
      /\btoday'?s?\s+(?:[$\w.\/&-]+\s+){0,6}(?:news|events?|updates?|sources?|articles?|headlines?|videos?|uploads?|posts?|information|info|data|prices?|scores?|results?|versions?|releases?|rates?|values?|rankings?|standings?|polls?|odds?|availability|status|population|counts?|totals?)\b/i,
      /\b(?:news|updates?|sources?|headlines?)\b/i,
      /\b(?:[$\w.\/&-]+\s+){1,6}(?:news|updates?|headlines?)\b/i,
      /\b(?:[$\w.\/&-]+\s+){1,6}(?:events?|videos?|uploads?|posts?|information|info|data|prices?|scores?|results?|versions?|releases?|rates?|values?|rankings?|standings?|polls?|odds?|availability|status|population|counts?|totals?)\s+(?:today|currently|recently|latest|now|right\s+now)\b/i,
      /\b(?:events?|videos?|uploads?|posts?|information|info|data|prices?|scores?|results?|versions?|releases?|rates?|values?|rankings?|standings?|polls?|odds?|availability|status|population|counts?|totals?)\s+(?:of|for|from)\s+(?:[$\w.\/&-]+\s+){1,8}(?:today|currently|recently|latest|now|right\s+now)\b/i,
