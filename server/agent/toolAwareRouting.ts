...
const TOOL_AWARE_RULES: ToolAwareRule[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      new RegExp(String.raw`\b(?:[Dd]o|[Cc]an|[Cc]ould|[Ww]ill|[Ww]ould)\s+[Yy]ou\s+(?:[Pp]lease\s+)?[Rr]ecall\b(?!\s+(?:(?:[Nn]ot|[Nn]ever)\s+)?[Tt]o\b)(?=[^.!?\n]{1,120}${GENERIC_PUBLIC_PROPER_SUBJECT_PATTERN})`),
