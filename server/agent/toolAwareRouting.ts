...
const TOOL_AWARE_RULES: ToolAwareRule[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      new RegExp(String.raw`\bhow(?:'s|\s+(?:is|are))\s+${GENERIC_PUBLIC_PROPER_SUBJECT_PATTERN}\s+(?:doing|performing|trending|looking)\s+(?:today|currently|recently)\b`, "i"),
