...
const TOOL_AWARE_RULES: ToolAwareRule[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /\b(?:latest|current|recent)\s+(?:[$\w.-]+\s+){0,6}(?:news|events?|updates?|sources?|articles?|headlines?|information|info|data|prices?|scores?|results?|versions?|releases?|rates?|values?|rankings?|standings?|polls?|odds?|availability|status|population|counts?|totals?)\b/i,
      ...
      /\b(?:[$\w.-]+\s+){1,6}(?:events?|information|info|data|prices?|scores?|results?|versions?|releases?|rates?|values?|rankings?|standings?|polls?|odds?|availability|status|population|counts?|totals?)\s+(?:today|currently|recently|latest|now|right\s+now)\b/i,
      /\b(?:events?|information|info|data|prices?|scores?|results?|versions?|releases?|rates?|values?|rankings?|standings?|polls?|odds?|availability|status|population|counts?|totals?)\s+(?:of|for)\s+(?:[$\w.-]+\s+){1,8}(?:today|currently|recently|latest|now|right\s+now)\b/i,
