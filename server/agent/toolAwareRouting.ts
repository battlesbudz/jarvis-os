...
const TOOL_AWARE_RULES: ToolAwareRule[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /\btoday'?s?\s+(?:[$\w.\/&-]+\s+){0,6}(?:news|events?|games?|matches?|fixtures?|updates?|sources?|articles?|headlines?|videos?|uploads?|posts?|information|info|data|traffic|quality|conditions?|prices?|scores?|results?|versions?|releases?|rates?|values?|rankings?|standings?|polls?|odds?|availability|status|population|counts?|totals?)\b/i,
      /\b(?:news|updates?|sources?)\b/i,
      /^\s*(?:the\s+)?headlines?\s*\??\s*$/i,
      /\b(?:[$\w.\/&-]+\s+){1,6}(?:news|updates?)\b/i,
      /\b(?:[$\w.\/&-]+\s+){1,6}(?:events?|games?|matches?|fixtures?|headlines?|videos?|uploads?|posts?|information|info|data|traffic|quality|conditions?|prices?|scores?|results?|versions?|releases?|rates?|values?|rankings?|standings?|polls?|odds?|availability|status|population|counts?|totals?)\s+(?:today|currently|recently|latest|now|right\s+now)\b/i,
      /\b(?:events?|games?|matches?|fixtures?|headlines?|videos?|uploads?|posts?|information|info|data|traffic|quality|conditions?|prices?|scores?|results?|versions?|releases?|rates?|values?|rankings?|standings?|polls?|odds?|availability|status|population|counts?|totals?)\s+(?:of|for|from)\s+(?:[$\w.\/&-]+\s+){1,8}(?:today|currently|recently|latest|now|right\s+now)\b/i,
