...
export const mediaCapability: Capability = {
  id: "media",
  label: "Media (TTS, Image & Video Generation, YouTube & Video Transcription)",
  toolGroups: ["media"],
  tools: [speakTool, imageGenerateTool, videoGenerateTool, youtubeTranscriptTool, videoTranscriptTool],
  configRequirements: [
