  ...
  const nodes: GatewayNode[] = [
    {
      ...
      lastSeenAt: now,
      actions: ["gateway.status", "events.list", "actions.invoke", "code.change.request", "repo.branch.push", "repo.pr.create", "repo.pr.status", "chat.send", "jobs.create", "cron.create"],
