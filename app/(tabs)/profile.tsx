...
import ProfileDocumentsPanel, { type UserDocument } from '@/components/profile/ProfileDocumentsPanel';
      ...
      >
        ...
        <Animated.View entering={FadeInDown.duration(400).delay(460)}>
          <ProfileDocumentsPanel
            ...
            profileChipColor={PROFILE_CHIP}
            sectionTitleStyle={styles.sectionTitle}
            platformsListStyle={styles.platformsList}
